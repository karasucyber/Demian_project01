...
const instructor = {
  ...
  championships: 15,
  students: 120,
  specialties: ["Jiu-Jitsu No-Gi (Sem Kimono)", "Fundamentos Sólidos", "Estratégia para Competição", "Técnicas Intermediárias"],
  location: "São Paulo, Brasil",
  quote: "A vida vai te amassar, para extrair o melhor de você. O tatame te prepara para isso.",
  trajectory: [
    { year: "2005", title: "Raízes na Bahia", description: "Iniciou sua jornada em Alagoinhas sob a orientação do mestre Everton Almeida." },
    { year: "2017", title: "Consagração Mundial", description: "Alcançou o topo do mundo ao conquistar o Mundial da CBJJE." },
    { year: "2018", title: "Mestria no Ensino", description: "Consolidou sua didática como professor principal de fundamentos e intermediários." },
    { year: "2024", title: "Conquista da Europa", description: "Campeão Europeu No-Gi IBJJF, reafirmando sua técnica em nível global." },
    { year: "Hoje", title: "Referência Técnica", description: "Lidera as aulas na Escola Demian Maia com foco em eficiência e precisão." }
  ],
  achievements: [
    { title: "Campeão Europeu No-Gi IBJJF", year: "2024", category: "Elite Internacional" },
    { title: "2x Campeão Brasileiro No-Gi", year: "CBJJ", category: "Referência Sem Kimono" },
    { title: "Campeão Mundial CBJJE", year: "2017", category: "Título Máximo" },
    { title: "3x Campeão BJJ PRO", year: "CBJJ", category: "Circuito Profissional" },
    { title: "2x Campeão Sul-Americano", year: "No-Gi CBJJ", category: "Domínio Continental" }
  ],
  bio: "Lucas Costa Barros é sinônimo de técnica refinada e combatividade. Com 21 anos de experiência, ele se tornou uma das maiores autoridades da escola na modalidade No-Gi (sem kimono), acumulando títulos nos maiores palcos do mundo, como o Europeu da IBJJF. Professor principal das turmas de Fundamentos e Intermediários, Lucas é reconhecido pela paciência didática e pela habilidade de transformar a complexidade do Jiu-Jitsu em aprendizado acessível para todos os níveis."
};
