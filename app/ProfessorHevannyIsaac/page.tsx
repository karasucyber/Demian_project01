...
const instructor = {
  ...
  championships: 5,
  students: 100,
  specialties: ["Defesa Pessoal", "Quedas e Projeções", "Passagem de Guarda", "Gestão de Metodologia"],
  location: "São Paulo, Brasil",
  quote: "Jiu-Jítsu é mais que uma Arte Marcial, é uma forma de Viver com verdade e propósito.",
  trajectory: [
    { year: "2001", title: "Propósito Encontrado", description: "Após anos no Karatê e Capoeira, descobriu a eficiência real no Jiu-Jitsu." },
    { year: "2016", title: "Linhagem Demian Maia", description: "Tornou-se aluno e instrutor formado diretamente pelo mestre Demian." },
    { year: "2019", title: "Destaque Mundial", description: "Conquistou o 3º lugar no Campeonato Mundial CBJJE." },
    { year: "Atual", title: "Expansão do Legado", description: "Responsável técnico pelo relacionamento e padronização das filiais Demian Maia." }
  ],
  achievements: [
    { title: "3º Lugar Mundial CBJJE", year: "2019", category: "Categoria de Peso" },
    { title: "Faixa Preta 3º Grau", year: "Demian Maia", category: "Graduado pela fonte" },
    { title: "Gestor de Filiais", year: "Metodologia", category: "Padronização Técnica Nacional" },
    { title: "Especialista em No-Gi", year: "Elite", category: "Luta Sem Kimono" }
  ],
  bio: "Com um quarto de século dedicado à arte suave, Hevanny Isaac, o 'Zacky', é um dos pilares da Escola Demian Maia. Graduado pelo próprio Demian, sua atuação vai além do tatame: ele é o guardião da nossa metodologia, garantindo que a essência técnica e os valores da escola sejam replicados em todas as nossas filiais. No tatame, é um mestre nas transições de quedas e na arte de passar guardas com precisão cirúrgica."
};
